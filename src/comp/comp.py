...
print("Starts with D:")
a = [human.name for human in humans if (
    len(human.name) > 0) and human.name[0] == 'D']
print(a)

# Write a list comprehension that creates a list of names of everyone
# whose name ends in "e".
print("Ends with e:")
b = [human.name for human in humans if (
    len(human.name) > 0) and human.name[-1] == 'e']
print(b)
...
allowed = {'C', 'D', 'E', 'F', 'G'}
c = [human.name for human in humans if human.name[0] in allowed]
print(c)
